<script lang="ts">
    ...
    function drawTile(x: number, y: number, value: number) {
        ...
        const spawnAnim = animations.find(
            (anim) =>
                anim.type === "spawn" &&
                anim.toX === x &&
                anim.toY === y &&
        ...
        if (direction === "left" || direction === "right") {
            for (let y = 0; y < 4; y++) {
                ...
                for (
                    ...
                    if (
                        originalIndex < originalPositions.length - 1 &&
                        newValue ===
                            oldGrid[y][originalPositions[originalIndex]] * 2 &&
                        oldGrid[y][originalPositions[originalIndex]] ===
                            oldGrid[y][originalPositions[originalIndex + 1]]
                    ) {
                        ...
                        animations.push({
                            ...
                            mergedFrom: [
                                ...
                                {
                                    x: originalPositions[originalIndex + 1],
                                    y: y,
                                },
                            ],
                        });
                        ...
                        // Regular movement
                        if (
                            originalPositions[originalIndex] !== newX ||
                            oldGrid[y][originalPositions[originalIndex]] !==
                                newValue
                        ) {
                            moved = true;
            ...
            for (let x = 0; x < 4; x++) {
                ...
                for (
                    ...
                    if (
                        originalIndex < originalPositions.length - 1 &&
                        newValue ===
                            oldGrid[originalPositions[originalIndex]][x] * 2 &&
                        oldGrid[originalPositions[originalIndex]][x] ===
                            oldGrid[originalPositions[originalIndex + 1]][x]
                    ) {
                        // Create merge animation
                        animations.push({
                            value: newValue,
                            ...
                            mergedFrom: [
                                ...
                                {
                                    x: x,
                                    y: originalPositions[originalIndex + 1],
                                },
                            ],
                        });
                        originalIndex += 2; // Skip the next tile as it's merged with this one
                        ...
                        // Regular movement
                        if (
                            originalPositions[originalIndex] !== newY ||
                            oldGrid[originalPositions[originalIndex]][x] !==
                                newValue
                        ) {
                            moved = true;
